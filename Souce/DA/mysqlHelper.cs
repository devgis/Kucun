...
namespace CY.DA
{
    ...
    public abstract class MySqlHelper
    {
        ...
        #region 数据库连接字符串
        //sql.ea-ex.com  203.175.171.121
        public static readonly string DBConnectionString = "Server=sql.ea-ex.com;Database=eaex_root;Uid=eaex_root;Pwd=u854gTbK;charset=utf8";
