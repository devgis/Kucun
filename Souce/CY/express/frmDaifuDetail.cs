...
{
    public partial class frmDaifuDetail : Form
    {
        ...
        public frmDaifuDetail(string wdid, string moneysg, string no,string uname)
        {
            if (moneysg == "")
            {
                moneysg = "0";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (bResult)
                    {
                        DA.Express.InsertDaifu(filename, cobBank.SelectedValue.ToString(), txtremark.Text, pub.username, m_wdid,txtpayid.Text);
                    }
                }
